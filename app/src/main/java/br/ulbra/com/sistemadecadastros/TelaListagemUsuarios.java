package br.ulbra.com.sistemadecadastros;
...
public class TelaListagemUsuarios {
    ...
    public void CarregarTela() {
        ...
        txtnome = (EditText) act.findViewById(R.id.edtNomeLista);
        txtendereco = (EditText) act.findViewById(R.id.edtEnderecoLista);
        txttelefone = (EditText) act.findViewById(R.id.edtTelefoneLista);
